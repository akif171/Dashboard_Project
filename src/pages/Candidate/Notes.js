...
const Notes = () => {
  return (
    <>
      {/* <Note /> */}
      <div className="w-full h-96 px-6 flex-col justify-start items-start gap-6 inline-flex font-normal mt-5">
        ...
        <div className="self-stretch h-32 border border-zinc-100 flex-col justify-start items-start flex">
          ...
          <div className="self-stretch bg-white shadow-inner justify-start items-start inline-flex">
            ...
            <div className="grow shrink basis-0 self-stretch text-zinc-800 text-base font-normal font-['Poppins'] leading-normal">
              ...
              nunc congue viverra. Duis condimentum risus sit amet tellus
              gravida, eget tincidunt nisi aliquam. Nunc posuere nunc urna, eget
              finibus tellus finibus lobortis.
            </div>
            <div className="h-16 opacity-0 bg-white bg-opacity-0 flex-col justify-start items-start inline-flex">
              <div className="w-8 grow shrink basis-0 bg-fuchsia-300 flex-col justify-center items-center flex">
                <div className="h-px justify-start items-start gap-8 inline-flex">
        ...
        <div className="self-stretch h-44 border border-zinc-100 flex-col justify-start items-start flex">
          <div className="h-3 opacity-0 bg-white bg-opacity-0 flex-col justify-start items-start flex">
            <div className="self-stretch bg-fuchsia-300 justify-center items-center inline-flex">
              <div className="w-px flex-col justify-start items-start gap-3 inline-flex">
                <div className="self-stretch h-px bg-fuchsia-300" />
          ...
          <div className="self-stretch justify-between items-center inline-flex">
            <div className="justify-start items-center gap-2 flex">
              ...
              <div className="w-4 h-4 relative" />
              <div className="text-zinc-800 text-xs font-normal font-['Poppins'] leading-none">
                Notes
              </div>
              <div className="text-neutral-500 text-xs font-normal font-['Poppins'] leading-none">
                by
          ...
          <div className="self-stretch justify-start items-start inline-flex">
            ...
            <div className="grow shrink basis-0 self-stretch">
              <span className="text-zinc-800 text-base font-normal font-['Poppins'] leading-normal">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate ante eu odio ultrices laoreet. Vivamus placerat eros
                in justo vestibulum, ac mollis ex aliquam. Donec efficitur felis
                eget nunc congue viverra. Duis condimentum risus sit amet tellus
                gravida, eget tincidunt nisi aliquam. Nunc posuere nunc urna,
                eget finibus tellus finibus lobortis.{" "}
              </span>
              <span className="text-zinc-800 text-base font-normal font-['Poppins'] leading-normal">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate ante eu odio ultrices laoreet. Vivamus placerat eros
